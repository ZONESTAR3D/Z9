...
2. [Run PrusaSlicer](#2-run-prusaslicer-and-choose-the-printer)
3. [Slicing one color](#3-slicing-one-color)
4. [Slicing muti-color for E4 hotend](#4-slicing-muti-color-for-e4-hotend)
...
#### 4.8 Slicing
![](pic/slicing-8.png)  
#### 4.9 Preview the sliced result (gcode file) and then save to gcode file to your PC and then copy to SD card
![](pic/slicing-9.png)   
