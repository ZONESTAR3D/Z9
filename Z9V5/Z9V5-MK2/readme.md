...
> **Firmware source code** is the core part of the firmware. I.e it is the building block of firmware. The entire firmware can be thought of as different sub modules. For example let’s take a c program. It is divided into many sub files. These files are called source files. And, the entire program files are called source file or source code. Now our firmware source code is base on [**marlin**](https://www.marlinfw.org).
