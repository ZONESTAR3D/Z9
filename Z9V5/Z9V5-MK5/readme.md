...
- **Hotend fan duct [:arrow_down:](https://github.com/ZONESTAR3D/Z9/tree/main/Z9V5/Z9V5-MK5/6.PrintParts/fanduct_m4v6.zip)**. The dock of the extruder fan is may be damaged after using a while, yiou can download and print one to replace it.     
