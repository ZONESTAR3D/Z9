...
------
## Download Z9V5-MK5 files
- :arrow_down: [**Download all documents from github**](https://downgit.github.io/#/home?url=https:%2F%2Fgithub.com%2FZONESTAR3D%2FZ9%2Ftree%2Fmain%2FZ9V5%2FZ9V5-MK5)  
...
- **[:book: M4 Hotend user guide](https://bit.ly/3dIaaF5)**
...
- [:arrow_down:**Z9_M4_4CTest.gcode**](./2.Test_gcode/Z9_M4_4CTest.zip): A base 4 colors test file   
...
## 7. Others
### Filament holder
The filament holder of Z9V5Pro can support the vast majority of filament spool in the market, but there are also some filament spools that may be longer. You can download stl files and print them to replace the original ones.     
**[Download Filament holder stl file](./7.Others/Parts_stl_file/FilamentSpoolBracket_90mm.zip)**
### Power supply fan cover
The fan of the power supply may have some dust after long-term use. You can print a cover and install it on the power fan, which can be easier to clean. And this cover can also reduce the noise of the fan.    
**[Download fan cover stl file](./7.Others/Parts_stl_file/PSUfancover.zip)**
### Hotend FAN duct
...
**:book: [User guide](https://github.com/ZONESTAR3D/Upgrade-kit-guide/tree/main/)**
- **:gift: [Buy at our online store]() / [Buy at Aliexpress]()**  
